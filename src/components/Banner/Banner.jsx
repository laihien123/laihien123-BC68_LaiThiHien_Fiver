...
const Banner = () => {
   ...
   return (
      <section>
            ...
            <div className="homepage_layout container mt-36 text-center">
               <div className="w-1/2 homepage_content">
                  ...
                  <FormSearchProduct
                     ...
                     inputClass={"flex- py-3 focus:border-none focus:outline-none w-2/3"}
                  />
               </div>
         ...
         {/* categories */}
         <div className="homepage_list container grid grid-cols-9">
            {arrList.map((item) => {
               return (
                  <div style={{ padding: "6px" }}>
                     <div
                        className="list_item border font-normal rounded-2xl space-y-5 text-sm cursor-pointer"
                        style={{
