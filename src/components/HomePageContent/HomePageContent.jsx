...
const HomePageContent = () => {
   ...
   const serviceItems = [
      ...
      },
      {
         ...
         imgurl: "../../../public/image/popular_services/social-media-marketing.png",
         ...
         <section className="freelance_talent container">
            ...
            <div className="container mb-16 grid sm:grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-5">
               ...
               <div className="mt-10 space-y-10">
                  ...
                  <p className="text-xl">
                     Get results from skilled freelancers from all over the world, for every task,
                     at any price point.
                  </p>
               </div>
               {/* grid item */}
               <div className="mt-10 space-y-10">
                  ...
                  <p className="text-xl">
                     Pay per project or by the hour (Pro). Payments only get released when you
                     approve.
                  </p>
               </div>
               {/* grid item */}
               <div className="mt-10 space-y-10">
                  ...
                  <p className="text-xl">
                     Filter to find the right freelancers quickly and get great work delivered in no
                     time, every time.
                  </p>
               </div>
               {/* grid item */}
               <div className="mt-10 space-y-10">
                  ...
                  <p className="text-xl">
                     Chat with our team to get your questions answered or resolve any issues with
                     your orders.
                  </p>
               </div>
            </div>
         ...
         <section className="fiverr_pro container">
            ...
            >
               <div className="text-white space-y-5">
                  ...
                  <p>
                     An experienced e-Commerce project manager will plan, coordinate, and execute
                     your project. Overseeing a team of e-Commerce experts, they'll handle
                     everything from site building, design and content to optimization, marketing
                  ...
                  <button className="py-2 px-5 rounded-md font-bold">Get Started</button>
               </div>
               <img src="../../../public/image/fiverr_pro.png" className="my-auto" alt="" />
            </div>
         </section>
         ...
         <section className="about_fiverr container">
            ...
            <div className="fiverr_logo_maker grid grid-cols-2 my-10">
               <div className="space-y-10 p-20">
                  ...
                  <button className="py-3 px-5 rounded-md text-white">Try Fiverr Logo Maker</button>
               </div>
               <div className="p-20">
                  <img src="../../../public/image/fiverr_logo_maker.png" width="100%" alt="" />
               </div>
            </div>
         </section>
                     ...
                     <div className="card w-1/4 relative p-2" key={item.id}>
                        <div className="relative group overflow-hidden">
                           <div className="card_image">
                              <img src={item.path} style={{ borderRadius: "10px" }} alt="" />
                           </div>
